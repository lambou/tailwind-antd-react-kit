...
export type HeroCardImageLeftProps = React.HTMLAttributes<HTMLDivElement> & {
  /**
   * Newsletter form
   */
...
const HeroCardImageLeft = React.forwardRef<
  HTMLDivElement,
  HeroCardImageLeftProps
>((props, ref) => {
  // explode props
  const {
    cardProps,
...
HeroCardImageLeft.defaultProps = {
  cardProps: undefined,
  gapClass: undefined,
  padding: false,
  image: undefined,
...
export default HeroCardImageLeft;
